/* Stage 27B: non-blocking ES module smoke/parity checks.
...
import * as utils from './esm/utils-stage27b.js';
import { createApi as createBlockStyleApi } from './esm/block-style-stage27b.js';

const W = window;
const STAGE = 'stage27b-20260425-1';
const checks = [];
...
markLoaded('js/esm/utils-stage27b.js');
markLoaded('js/esm/block-style-stage27b.js');
...
markLoaded('js/es-module-smoke-stage27b.js');

if(!report.ok){
  markFailed('Stage 27B ES module smoke checks failed: ' + failed.map((item)=>item.name).join(', '));
}
