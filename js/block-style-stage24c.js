...
(function(){
  function createApi(deps){
    ...
    function titleWrapperStyle(style, heading){
      ...
      const baseMap = { h1:'calc(var(--theme-title-h1-font-size,5.6rem) * var(--title-scale,1))', h2:'calc(var(--theme-title-h2-font-size,3.1rem) * var(--title-scale,1))', h3:'var(--theme-block-heading-font-size,2.45rem)', h4:'2.1rem', h5:'1.8rem', h6:'1.55rem' };
