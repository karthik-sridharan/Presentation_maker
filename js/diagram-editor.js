/* Diagram editor module: simple diagram editor popup extracted from legacy-app.js.
   Classic-script module; exposes window.LuminaDiagramEditor. */
(function(global){
  'use strict';
  ...
  global.LuminaDiagramEditor = { createApi };
})(window);
