/* Stage 27A migration note:
   ...
   Stage 27A then loads a module smoke harness that imports ESM utilities and
   compares them against the classic globals. */
(function(global){
  'use strict';
  global.LuminaModuleManifest = Object.freeze({
    stage: 'stage27a-20260425-1',
    assets: [
    ...
    notes: [
      'Stage 27A starts ES module migration without changing the authoritative runtime.',
      'Leaf helpers have ESM copies under js/esm/.',
      'js/es-module-smoke-stage27a.mjs imports the ESM helpers and verifies parity with classic globals.',
