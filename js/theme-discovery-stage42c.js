/* theme-discovery-stage42c.js — visible Theme Designer + Theme Copilot entry points. */
(function(){
  'use strict';
  var W=window,D=document;
  var STAGE='stage42c-theme-discovery-20260501-1';
  var SIG='index-inline-stage42c-theme-discovery-20260501-1';
  ...
  function ensureEntry(){
    ...
    if(!host){
      ...
      host.innerHTML=''
        +'<div class="stage42c-head"><div><div class="smallcaps">Theme Designer</div><h2>Design theme + Theme Copilot</h2><p>Theme controls and Theme Copilot now live directly in the Design tab. Use the designer for colors, typography, chrome, and reusable JSON themes; use Theme Copilot to match a reference presentation.</p><div class="stage42c-path">Path: <b>Design</b> → <b>Theme Designer</b> / <b>Theme Copilot</b></div></div><span class="stage42c-chip">Stage 42C visible entry</span></div>'
  ...
  function publishStatus(){W.__LUMINA_STAGE42C_THEME_DISCOVERY_STATUS=status();}
  function ensure(){
