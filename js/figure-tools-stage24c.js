/* Stage 18B migration note:
   ...
   Stage 35Z patch: contextual figure actions, robust single-click selection, and fully freeform drag/resize during pointer movement. Stage 41I adds delete selected figure/block actions.
*/
(function(){
...
function fitFiguresIn(root){
  ...
  window.LuminaFigureTools = { createApi };
})();
