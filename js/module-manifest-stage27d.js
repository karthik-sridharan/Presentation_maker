...
(function(global){
  ...
  global.LuminaModuleManifest = Object.freeze({
    stage: 'stage27d-20260425-1',
    assets: [
      'css/styles-stage24c.css',
      'js/diagnostics-stage27d.js',
      'js/module-manifest-stage27d.js',
      ...
      'js/es-module-loader-stage27d.js'
    ],
    optionalAssets: [
    ...
    notes: [
      'Stage 27D hotfixes Stage 27D external-module startup failures.',
      'The production app loads js/es-module-loader-stage27d.js as a classic required script.',
      'The loader attempts an optional dynamic import of js/es-module-smoke-stage27d.js only when the browser/server environment allows it.',
