/* Stage 27D: non-blocking ES module smoke/parity checks.
...
import * as utils from './esm/utils-stage27d.js';
import { createApi as createBlockStyleApi } from './esm/block-style-stage27d.js';
...
markLoaded('js/esm/utils-stage27d.js');
markLoaded('js/esm/block-style-stage27d.js');
...
markLoaded('js/es-module-smoke-stage27d.js');

if(!report.ok){
  if(W.LuminaDiagnostics && typeof W.LuminaDiagnostics.warn === 'function'){
    W.LuminaDiagnostics.warn('Stage 27D ES module smoke checks failed: ' + failed.map((item)=>item.name).join(', '));
  }
}
