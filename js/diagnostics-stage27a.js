(function () {
  ...
  function collectReport() {
    ...
    return {
      ...
      esModuleSmokePassed: !!(W.LuminaEsModuleDiagnostics && W.LuminaEsModuleDiagnostics.ok),
  ...
  function delayedChecks() {
    ...
    if (!report.esModuleSmokePassed) W.luminaBootError('ES module smoke diagnostics missing or failed.');
    ensureButton();
  }
