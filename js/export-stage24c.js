...
.slide-actions{position:absolute;top:1.05rem;left:auto;right:1.2rem;display:flex;gap:.55rem;z-index:10;flex-wrap:nowrap;justify-content:flex-end;align-items:center;width:auto;max-width:calc(100% - 15rem);overflow-x:auto;overflow-y:hidden;white-space:nowrap;scrollbar-width:none;padding-bottom:.08rem}
.slide-actions::-webkit-scrollbar{display:none}
.slide-actions > *{flex:0 0 auto}
@media (max-width:720px){.slide-actions{top:4.85rem;left:1rem;right:1rem;max-width:calc(100% - 2rem);justify-content:flex-end}}
