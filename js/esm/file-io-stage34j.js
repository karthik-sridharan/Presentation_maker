/* Stage 42K: browser-compatible ES module file/import workflow helpers with patch-task AI repair.
...
function mergeSourcePreservationIntoAiDeck(deck, sourceSlides, originalProblems){
  ...
  async function maybeReviewImportedDeckWithAi(importedSlides, deckTitle){
    ...
    try{
      ...
      const stats = deck && deck.aiPatchStats || globalThis.__LUMINA_STAGE42K_PATCH_AI_IMPORT_REPAIR || globalThis.__LUMINA_STAGE42J_PATCH_AI_IMPORT_REPAIR || globalThis.__LUMINA_STAGE42I_PATCH_AI_IMPORT_REPAIR || globalThis.__LUMINA_STAGE42H_PATCH_AI_IMPORT_REPAIR || null;
