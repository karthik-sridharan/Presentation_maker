/* Stage 41J: custom HTML slides are included in standalone PDF export via visible-area snapshots.
   Based on Stage 34J: browser-compatible ES module version of export helpers.
