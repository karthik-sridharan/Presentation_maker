/* Stage 27D: classic-script ES module loader.
...
(function () {
  ...
  markLoaded('js/es-module-loader-stage27d.js');
  setReport({
    stage: STAGE,
    checkedAt: now(),
    ok: null,
  ...
  var scriptUrl = (document.currentScript && document.currentScript.src) || (W.location.href.replace(/[^/]*$/, '') + 'js/es-module-loader-stage27d.js');
  var specifier;
  try {
    specifier = new URL('es-module-smoke-stage27d.js?v=' + encodeURIComponent(STAGE), scriptUrl).href;
  } catch (e) {
    specifier = 'js/es-module-smoke-stage27d.js?v=' + encodeURIComponent(STAGE);
  }
  importer(specifier).then(function (module) {
    ...
    if (D && typeof D.markOptionalFailed === 'function') D.markOptionalFailed('js/es-module-smoke-stage27d.js', message);
