(function () {
  ...
  function delayedChecks() {
    ...
    if (report.esModuleSmokeStatus !== 'passed') D.warn('ES module smoke status: ' + report.esModuleSmokeStatus + '. This is optional in Stage 27D and does not block the classic runtime.');
    ensureButton();
  }
