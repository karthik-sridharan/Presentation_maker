/* Stage 28C: non-blocking ES module smoke/parity checks.
...
import * as utils from './esm/utils-stage28c.js';
import { createApi as createBlockStyleApi } from './esm/block-style-stage28c.js';
import { createApi as createParserApi } from './esm/parser-stage28c.js';
import { createApi as createImportApi } from './esm/import-stage28c.js';

const W = window;
const STAGE = 'stage28c-20260425-1';
const checks = [];
...
markLoaded('js/es-module-smoke-stage28c.js');

if(!report.ok && W.LuminaDiagnostics && typeof W.LuminaDiagnostics.warn === 'function'){
  W.LuminaDiagnostics.warn('Stage 28C ES module smoke checks failed: ' + failed.map((item)=>item.name).join(', '));
}
