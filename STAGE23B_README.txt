...
This patch keeps the existing stage23b2 filenames to avoid missing-file issues, but updates their cache-busting query strings to stage23b.

Test URL:
  index.html?v=stage23b2-20260425-1&clearLuminaStorage=1

Diagnostics:
  diagnostics-stage23b2.html?v=stage23b2-20260425-1

What changed:
- Adds window.LuminaRendererApi in js/renderer-stage23b2.js.
